    ...
    <>
      ...
      {!data?.items.length ? (
        <EmptyState
          ...
          description="Crea tu primera transacción."
          action={
            <button
              onClick={() => setCreating(true)}
              className="px-4 py-2 bg-blue-600 text-white text-sm rounded-md hover:bg-blue-700"
          ...
          <div className="overflow-x-auto rounded-lg border border-gray-200 dark:border-gray-700">
            <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
              <thead className="bg-gray-50 dark:bg-gray-800">
                <tr>
                  {['Fecha', 'Descripción', 'Categoría', 'Líneas', 'Estado'].map((h) => (
                    ...
                    <tr key={tx.id} className="hover:bg-gray-50 dark:hover:bg-gray-800/50">
                      ...
                      <td className="px-4 py-3 text-sm">
                        <div className="flex items-center gap-2">
                          <span className="text-gray-500 dark:text-gray-400">{tx.entries.length} líneas</span>
      ...
      <Modal open={creating} onClose={() => setCreating(false)} title="Nueva transacción">
