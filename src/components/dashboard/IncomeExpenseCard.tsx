      ...
      {isLoading ? (
        ...
        <div className="space-y-1.5">
          <div className="flex justify-between text-sm">
            <span className="text-gray-500 dark:text-gray-400">{t('dashboard.income')}</span>
            <MoneyDisplay amount={income} currency={currency} colored />
          </div>
          <div className="flex justify-between text-sm">
            <span className="text-gray-500 dark:text-gray-400">{t('dashboard.expenses')}</span>
          ...
          <div className="flex justify-between text-base font-semibold border-t border-gray-100 dark:border-gray-700 pt-1.5">
            <span className="text-gray-700 dark:text-gray-300">{t('dashboard.result')}</span>
